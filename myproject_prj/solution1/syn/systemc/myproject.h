...
struct myproject : public sc_module {
    ...
    sc_signal< sc_logic > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_data_0_V_V_TREADY;
    sc_signal< sc_logic > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_data_1_V_V_TREADY;
    sc_signal< sc_logic > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_data_2_V_V_TREADY;
    sc_signal< sc_logic > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_data_3_V_V_TREADY;
    sc_signal< sc_logic > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_data_4_V_V_TREADY;
    sc_signal< sc_logic > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_data_5_V_V_TREADY;
    sc_signal< sc_logic > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_data_6_V_V_TREADY;
    sc_signal< sc_logic > zeropad2d_cl_me_ap_fixed_ap_fixed_config4_U0_data_7_V_V_TREADY;
