...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_3_V_V_TDATA { I 16 vector } data_3_V_V_TVALID { I 1 bit } data_3_V_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_4_V_V_TDATA { I 16 vector } data_4_V_V_TVALID { I 1 bit } data_4_V_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_5_V_V_TDATA { I 16 vector } data_5_V_V_TVALID { I 1 bit } data_5_V_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_6_V_V_TDATA { I 16 vector } data_6_V_V_TVALID { I 1 bit } data_6_V_V_TREADY { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'data_6_V_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_7_V_V_TDATA { I 16 vector } data_7_V_V_TVALID { I 1 bit } data_7_V_V_TREADY { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'data_7_V_V'"
}
}
